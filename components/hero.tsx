    ...
    <section className="relative min-h-screen flex items-center justify-center">
      ...
      >
        <div className="flex flex-col items-center justify-center">
          <p
            className={`text-xl sm:text-2xl uppercase tracking-[0.3em] text-white/90 mb-4 transition-all duration-1000 delay-200 ${
          ...
          <h1
            className={`text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[6rem] font-light leading-tight text-white mb-6 transition-all duration-1000 delay-300 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            Підкресли свою
          ...
          <p
            className={`text-2xl sm:text-3xl md:text-4xl text-white/80 max-w-2xl mb-10 leading-relaxed transition-all duration-1000 delay-500 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
          ...
          >
            <Button
              asChild
              size="lg"
            className="w-full sm:w-80 bg-red-900 hover:bg-red-800 text-white rounded-full px-8 py-6 text-2xl sm:text-3xl font-medium shadow-xl"
            >
              <Link
            ...
            <Button
              ...
              variant="outline"
              size="lg"
            className="w-full sm:w-80 rounded-full px-8 py-6 text-2xl sm:text-3xl border-2 border-white text-white hover:bg-white/20 bg-transparent backdrop-blur-sm"
            >
